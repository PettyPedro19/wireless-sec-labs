...
run_iperf_test "UDP Base (Client -> Server)" "-u -b 1000M"
run_iperf_test "UDP Base REVERSE (Server -> Client)" "-u -b 1000M -R"

# 3. UDP Ottimizzato per MTU (Nessuna frammentazione)
run_iperf_test "UDP 1472B (Client -> Server)" "-u -b 1000M -l 1472"
run_iperf_test "UDP 1472B REVERSE (Server -> Client)" "-u -b 1000M -l 1472 -R"

# 4. UDP Frammentato (Disastro prestazionale garantito)
run_iperf_test "UDP 1473B Frammentato (Client -> Server)" "-u -b 1000M -l 1473"
run_iperf_test "UDP 1473B Frammentato REVERSE (Server -> Client)" "-u -b 1000M -l 1473 -R"
